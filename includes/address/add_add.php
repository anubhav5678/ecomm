<?php
    // Code for adding the user's address from my addressess page.
    if (isset($_POST['save_address'])) {
        ...
        redirect("my_addressess.php?a=show"); // Redirecting to the my addressess page.
    }
?>
<section class="container-form">
    <div class="form" style="border: none; padding: 20px 10px;">
